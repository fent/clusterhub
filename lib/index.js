...
cluster.fork = function() {
  var worker = origFork();
  var events = {};
  var obj = { worker: worker, events: events };
  workers.push(obj);
  notready++;
...
// expose cluster
var isMaster = globalHub.isMaster = cluster.isMaster;
var isWorker = globalHub.isWorker = cluster.isWorker;
